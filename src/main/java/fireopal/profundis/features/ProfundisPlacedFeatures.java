...
//     public static RegistryKey<PlacedFeature> register(String id, RegistryEntry<? extends ConfiguredFeature<?, ?>> registryEntry, PlacementModifier ... modifiers) {
...
//     public static final RegistryKey<PlacedFeature> ICY_SURFACE = register("icy_surface",
//         ProfundisConfiguredFeatures.SMALL_ICY_SURFACE,
