...
//     private static RegistryKey<ConfiguredFeature<?, ?>> createRegistryKey(String id) {
//         return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Profundis.id(id));
//     }

//     private static <FC extends FeatureConfig, F extends Feature<FC>> ConfiguredFeature<FC, ?> configure(F feature, FC config) {
//         return new ConfiguredFeature<>(feature, config);
//     }

//     private static final RuleTest RULE_TEST_BASE_STONE_OVERWORLD = new TagMatchRuleTest(BlockTags.BASE_STONE_OVERWORLD);

//     public static final RegistryKey<ConfiguredFeature<?, ?>> SMALL_ICY_SURFACE = createRegistryKey("small_icy_surface");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> NO_OP = createRegistryKey("no_op");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> LARGE_ICY_SURFACE = createRegistryKey("large_icy_surface");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> SNOW_LAYER_CAVE = createRegistryKey("snow_layer_cave");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> FROZEN_AQUIFER = createRegistryKey("frozen_aquifer");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> FROZEN_LAVA_AQUIFER = createRegistryKey("frozen_lava_aquifer");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> SMALL_ICICLES = createRegistryKey("small_icicles");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> LARGE_ICICLES = createRegistryKey("large_icicles");
//     public static final RegistryKey<ConfiguredFeature<?, ?>> ICE_PILLAR = createRegistryKey("ice_pillar");


//     public static void populate(FabricDynamicRegistryProvider.Entries entries) {
//         entries.add(SMALL_ICY_SURFACE, configure(
...
//                 Blocks.ICE.getDefaultState(),
//                 RULE_TEST_BASE_STONE_OVERWORLD,
...
//         entries.add(NO_OP, configure(
//             Feature.NO_OP,
//             new DefaultFeatureConfig()
//         ));

//         entries.add(LARGE_ICY_SURFACE, configure(
//             ProfundisFeatures.NETHERRACK_BASE_FEATURE,
//             new NetherrackBaseFeatureConfig(
...
//         entries.add(SNOW_LAYER_CAVE, configure(
...
//         entries.add(FROZEN_AQUIFER, configure(
//             ProfundisFeatures.CAVE_SURFACE_FEATURE,
//             new CaveSurfaceFeatureConfig(
...
//         entries.add(SMALL_ICICLES, configure(
...
//         entries.add(LARGE_ICICLES, configure(
//             ProfundisFeatures.ICICLE_FEATURE,
//             new IcicleFeatureConfig(
...
//             )
//         ));
//         entries.add(ICE_PILLAR, configure(
