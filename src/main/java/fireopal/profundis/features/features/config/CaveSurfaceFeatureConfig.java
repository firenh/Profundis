...
public record CaveSurfaceFeatureConfig(IntProvider size, int offset, BlockState blockState, float chance,
                                       boolean onSpecificBlockState, IntProvider amountOfCircles,
                                       BlockState targetBlock, boolean onlyOnBaseStoneOverworld,
                                       boolean generateManyCircles) implements FeatureConfig {
