...
public record CavePillarFeatureConfig(BlockState innerState, BlockState outerState, IntProvider sizeOfEnds,
                                      IntProvider lengthOfEnds,
                                      RegistryEntry<PlacedFeature> bottomFeature) implements FeatureConfig {
