...
public record IcicleFeatureConfig(IntProvider size, IntProvider amount, IntProvider spread, BlockState innerState, BlockState outerState) implements FeatureConfig {
